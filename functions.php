...
function load_corejs() {
	wp_register_script( 'corejs', 'https://cdn.jsdelivr.net/npm/core-js-bundle@3.21.1/minified.js' );
	wp_enqueue_script( 'corejs', 'https://cdn.jsdelivr.net/npm/core-js-bundle@3.21.1/minified.js' );
}
